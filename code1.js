...
isConditionTrue_0 = gdjs.playerAuthentication.isAuthenticated();
if (isConditionTrue_0) {
{gdjs.evtTools.leaderboards.saveConnectedPlayerScore(runtimeScene, "e55f6dd4-3479-484a-bef6-fcff1ec0a4ca", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("Score")));
}}
...
{gdjs.evtTools.leaderboards.savePlayerScore(runtimeScene, "e55f6dd4-3479-484a-bef6-fcff1ec0a4ca", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("Score")), (( gdjs.LeaderboardCode.GDPlayerNameInputObjects2.length === 0 ) ? "" :gdjs.LeaderboardCode.GDPlayerNameInputObjects2[0].getText()));
...
}{gdjs.evtTools.leaderboards.displayLeaderboard(runtimeScene, "e55f6dd4-3479-484a-bef6-fcff1ec0a4ca", true);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.leaderboards.hasBeenSaved("e55f6dd4-3479-484a-bef6-fcff1ec0a4ca");
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Game", false);
}}
